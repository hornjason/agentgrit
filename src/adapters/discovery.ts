...
export function installHooks(settingsPath: string): {
  ...
  const hookDefs: Array<{
    ...
    { event: "PostToolUse", matcher: "Bash", command: "npx agentgrit capture incident", timeout: 5000 },
    ...
    { event: "SessionEnd", matcher: "", command: "npx agentgrit capture work-completion", timeout: 10000 },
  ];
